        ...
        <div class="container-fluid jumbotron" style="margin-top:0px;">
            ...
            <div class="col-lg-7 col-sm-12 col-lg-offset-2 jumbotron" style="border:3px #FFFFFF solid; background:#FFFFFF" id="AddMarksStep1">
                <div class="col-lg-12" id="main">
                    <div class="col-lg-2" style="margin-top:7px;"><img src="../images/alhelal-logo.png" style="height:80px;50px; margin-bottom:5px;" class="img-rounded" /></div>
...
Al Helal Academy
                    ...
                    <div class="col-lg-10 col-md-10  col-lg-offset-1" style="margin-top:20px;">
                        <div style="border:1px #000000 solid">
                            <table class="table-responsive" border="0">
                                <tr>
                                    ...
                                    <td width="276">
                                        <select class="form-control" style=" margin-top:5px;" name="className" id="className">
                                                ...
                                                <option value="311609100003andSix Boys">Six Boys</option><span id="item_result"></span>
                                                <option value="311609110004andSeven Boys">Seven Boys</option><span id="item_result"></span>
                                                <option value="311609230005andEight Boys">Eight Boys</option><span id="item_result"></span>
                                                <option value="311609230006andNine Boys">Nine Boys</option><span id="item_result"></span>
                                                <option value="311609230007andTen Boys">Ten Boys</option><span id="item_result"></span>
                                                <option value="312101010008andSSC ">SSC </option><span id="item_result"></span>
                                                <option value="312301060009andSix Girls">Six Girls</option><span id="item_result"></span>
                                                <option value="312301060010andSeven Girls">Seven Girls</option><span id="item_result"></span>
                                                <option value="312301060011andEight Girls">Eight Girls</option><span id="item_result"></span>
                                                <option value="312301060012andNine Girls">Nine Girls</option><span id="item_result"></span>
                                                <option value="312301060013andTen Girls ">Ten Girls </option><span id="item_result"></span>
                                                <option value="312309110014and1">1</option><span id="item_result"></span>
                                                <option value="312309110015andone">one</option><span id="item_result"></span>
                                                <option value="312309240016andeleven">eleven</option><span id="item_result"></span>
                                                <option value="312310050017andWeb Dev">Web Dev</option><span id="item_result"></span>
                                ...
                                <tr>
                                    <td width="168">&nbsp;<strong>8+3 </strong>
                                        <input type="hidden" name="a" id="a" value="8" />
                                        <input type="hidden" name="b" id="b" value="3" />
                                    </td>
                                    <td width="30">&nbsp;<strong>:</strong></td>
                                    <td width="276">
                ...
                <div class="col-lg-12" style="margin-top:1px; background:#E7E7E4; height:85px; border-radius:0px 0px 5px 5px">
                    ...
                    <table class="table-responsive" border="0">
                        <tr>
                            <td width="998" height="92"><span style="font-size:14px; color:#8C8C8C">	<h3 style="color:#ff0000">
						    শুধুমাত্র ক্লাস Eight Boys এর Half Year Exam- এর রেজাল্ট পাবলিস্ট করা হয়েছে |<br>Roll:1,2,3,4,5,6,7<br>
