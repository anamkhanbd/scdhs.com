...
<div class="container">
      ...
      <div class="col-sm-9 col-12">
        ...
        <div class="col-sm-12 col-12 p-0"  data-aos="fade-in" data-aos-duration="2000" >
          <ul class="list-group p-0">
           <li class="list-group-item font-weight-bold bg-success text-light" id="about">ফাইল সমূহ ডাউনলোড করুন</li>
         </ul>
   ...
   <li class="list-group-item p-0 pt-2" id="padd">
     <a href="https://skillbasedit.com/demo/President_Message"><center><img src="https://skillbasedit.com/demo/public/otherimage/1741209244067584.jpg" class="img-fluid" style="max-height: 200px;padding-bottom:5px;"></center></a>
   ...
   <li class="list-group-item p-0 pt-2" id="padd">
     <a href="https://skillbasedit.com/demo/message-from-head"><center><img src="https://skillbasedit.com/demo/public/otherimage/6511b91624acf.gif" class="img-fluid" style="max-height: 200px;padding-bottom:5px;"></center></a>
   ...
   <div class="col-sm-12 col-12 p-0 mt-3" data-aos="fade-in" data-aos-duration="1000">
    ...
    <div class="feature">
         ...
         <a href="https://skillbasedit.com/demo/adduseful_link" target="_blank"><li style='font-size:12px;'><span uk-icon="icon: triangle-right; ratio: 0.7"></span>&nbsp;&nbsp;Test</li></a>
       <a href="https://skillbasedit.com/demo/adduseful_link" target="_blank"><li style='font-size:12px;'><span uk-icon="icon: triangle-right; ratio: 0.7"></span>&nbsp;&nbsp;New Link</li></a>
