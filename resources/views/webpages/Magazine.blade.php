                        ...
                        <li class="list-group-item pb-5">
                            ...
                            <div class="row mt-3 border p-3">
                                <div class="col-md-3 col-12">
                                    <img src="{{ url('images/110822_11_13_51.png') }}" class="img-fluid"
                                        style="max-height: 300px;">
                                </div>
                                <div class="col-md-9 col-12">
                                    <h4><a href="{{ url('images/110822_11_13_51.png') }}" class="text-dark">Wall
                                            Magazine</a></h4>
                                    <span style="color: gray;">2022-08-11</span><br><br>
                                </div>
                            </div>
