                ...
                <div class="col-sm-9 col-12">
                    ...
                    <div class="col-sm-12 col-12 p-0" data-aos="fade-in" data-aos-duration="2000">
                        <ul class="list-group p-0">
                            <li class="list-group-item font-weight-bold bg-success text-light" id="about">বিজ্ঞান মেলা
                            </li>
                        </ul>
                        <li class="list-group-item pb-5">
                            ...
                            <div class="row mt-3 border p-3">
                                <div class="col-md-3 col-12">
                                    <img src="{{ url('images/180522_05_52_39.jpeg') }}" class="img-fluid"
                                        style="max-height: 300px;">
                                </div>
                                <div class="col-md-9 col-12">
                                    <h4><a href="#" class="text-dark">School science fair</a></h4>
                                    <span style="color: gray;">2022-05-18</span><br><br>
                                    <span>
                                        <div class="wDYxhc" data-md="401" lang="en-BD" data-hveid="CBEQAA"
                                            data-ved="2ahUKEwiR5rbpquj3AhUPT2wGHdtSCAkQ6YgDegQIERAA"
                                            style="clear: none; padding-left: 0px; padding-right: 0px;">
                                            <div class="Ss2Faf zbA8Me qLYAZd q8U8x" aria-level="3" role="heading"
                                                style="margin: 16px 16px 16px 0px; line-height...</span><br>
