                ...
                <div class="col-sm-9 col-12">
                    ...
                    <div class="col-sm-12 col-12 p-0" data-aos="fade-in" data-aos-duration="2000">
                        <ul class="list-group p-0">
                            <li class="list-group-item font-weight-bold bg-success text-light" id="about">ফটো গ্যালারী
                            </li>
                        </ul>
                        <li class="list-group-item">
                            <div class="row" uk-lightbox>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/01.jpg')}}"><img
                                            src="{{url('images/gallary/01.jpg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil, laudantium sequi.</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/02.jpg')}}"><img
                                            src="{{url('images/gallary/02.jpg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয় </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/03.jpg')}}"><img
                                            src="{{url('images/gallary/03.jpg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয়</p>
                                    </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/04.jpg')}}"><img
                                            src="{{url('images/gallary/04.jpg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয়</p>
                                    </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/05.jpeg')}}"><img
                                            src="{{url('images/gallary/05.jpeg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয়</p>
                                    </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/06.jpeg')}}"><img
                                            src="{{url('images/gallary/06.jpeg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয়</p>
                                    </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/07.jpeg')}}"><img
                                            src="{{url('images/gallary/07.jpeg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয়</p>
                                    </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/08.jpeg')}}"><img
                                            src="{{url('images/gallary/08.jpeg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয়</p>
                                    </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/09.jpeg')}}"><img
                                            src="{{url('images/gallary/09.jpeg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয়</p>
                                    </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <a href="{{url('images/gallary/10.jpeg')}}"><img
                                            src="{{url('images/gallary/10.jpeg')}}"
                                            alt="" class="img-fluid photoimg"></a>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>শিবদেব চর দ্বি মুখী উচ্চ বিদ্যালয়</p>
                                    </div>
