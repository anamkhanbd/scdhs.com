                    ...
                    <div class="col-sm-12 col-12 p-0" data-aos="fade-in" data-aos-duration="2000">
                        ...
                        <li class="list-group-item">
                            <div style="font-size: 14px; line-height: 25px; text-align: justify;">
                                <p><span style="color: rgb(88, 88, 88); font-size: 15px; font-weight: 700;">Our Uniform
                                        Would be like this</span><br></p>
                                <br>

                                <img src="{{url('images/150822_12_02_19.jpg')}}"
                                    class="img-fluid">
