                            ...
                            <table id="example" class="display table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr style="font-size: 12px;">
                                        <td>1</td>
                                        <td><a href="#"
                                                style="text-decoration: none;color: black">2022-08-04</a></td>
                                        <td><a href="#"
                                                style="text-decoration: none;color: black"></a></td>

                                        <td><a href="#"
                                                style="text-decoration: none;color: black">সাজেশন্স-2</a></td>

                                        <td>
                                            <a href="#"
                                                class="btn btn-sm btn-danger" download="সাজেশন্স-2">
                                    ...
                                    <tr style="font-size: 12px;">
                                        ...
                                        <td><a href="#"
                                                style="text-decoration: none;color: black">সাজেশন্স</a></td>

                                        <td>
                                            <a href="#"
                                                class="btn btn-sm btn-danger" download="সাজেশন্স">
                                                <img src="{{url('images/pdf_icon.png')}}"
                                                    class="img-fluid"></a>
                                        </td>
                                    </tr>
