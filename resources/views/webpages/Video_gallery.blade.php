                ...
                <div class="col-sm-9 col-12">
                    ...
                    <div class="col-sm-12 col-12 p-0" data-aos="fade-in" data-aos-duration="2000">
                        <ul class="list-group p-0">
                            <li class="list-group-item font-weight-bold bg-success text-light" id="about">ভিডিও গ্যালারী
                            </li>
                        </ul>
                        <li class="list-group-item">
                            <div class="row" uk-lightbox>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <iframe width="100%" height="250" src="https://www.youtube.com/embed/tCbe9eEjRho"
                                        frameborder="0"
                                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                        allowfullscreen></iframe>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>Meena: Mono Alo Meenar Grame</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-12 p-0">
                                    <iframe width="100%" height="250" src="https://www.youtube.com/embed/5UG5pcjW2qI"
                                        frameborder="0"
                                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                        allowfullscreen></iframe>
                                    <div class="uk-overlay uk-overlay-primary uk-position-bottom p-3">
                                        <p>Mina Raju UNICEF</p>
                                    </div>
                                </div>
