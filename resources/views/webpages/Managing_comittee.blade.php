                    ...
                    <div class="col-sm-9 col-12">
                        ...
                        <div class="col-sm-12 col-12 p-0">
                            <div class="row">
                                ...
                                <tr>
                                    <td rowspan="4">
                                    <center><img src="{{url('/images/1741228185130765.jpg')}}" class="img-fluid" id="" style="width: 100px;height: 100px"><br></center>
                                </td>
                                <th>Name</th>
                                <td>মোহাম্মদ ওমর ফারুক</td>
                                </tr>
                                ...
                                <tr>
                                    <td rowspan="4">
                                    <center><img src="{{url('/images/1741228413585612.jpg')}}" class="img-fluid" id="" style="width: 100px;height: 100px"><br></center>
                                </td>
                                <th>Name</th>
                                <td>ইমাম উদ্দিন ভূইয়াঁ</td>
                                </tr>
                                ...
                                <tr>
                                    <td rowspan="4">
                                    <center><img src="{{url('/images/1741228499636089.png')}}" class="img-fluid" id="" style="width: 100px;height: 100px"><br></center>
                                </td>
                                <th>Name</th>
                                <td>মোহাম্মদ কামাল উদ্দিন</td>
                                </tr>
                                ...
                                <tr>
                                    <td rowspan="4">
                                    <center><img src="{{url('/images/1741228568015092.png')}}" class="img-fluid" id="" style="width: 100px;height: 100px"><br></center>
                                </td>
                                <th>Name</th>
                                <td>জাহানারা বেগম</td>
                                </tr>
                                ...
                                <tr>
                                    <td rowspan="4">
                                    <center><img src="{{url('/images/1741228697369146.jpg')}}" class="img-fluid" id="" style="width: 100px;height: 100px"><br></center>
                                </td>
                                <th>Name</th>
                                <td>মোহাম্মদ ফাখার উদ্দিন</td>
                                </tr>
                                ...
                                <tr>
                                    <td rowspan="4">
                                    <center><img src="{{url('/images/1741228846708235.jpg')}}" class="img-fluid" id="" style="width: 100px;height: 100px"><br></center>
                                </td>
                                <th>Name</th>
                                <td>মোহাম্মদ মমিনুল হক</td>
                                </tr>
