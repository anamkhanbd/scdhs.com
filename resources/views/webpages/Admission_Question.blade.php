@extends('layout.main')
@push('title')
    <title>Asmission Question Idea </title>
@endpush
        ...
        <div class="col-sm-12 col-12" id="mainpage">
            ...
            <div class="col-sm-12 col-12 p-0" data-aos="fade-in" data-aos-duration="2000">
                <ul class="list-group p-0">
                    <li class="list-group-item font-weight-bold bg-success text-light" id="about">ভর্তি পরীক্ষার প্রশ্ন
                    </li>
                            ...
                            <table id="example" class="display table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr style="font-size: 12px;">
                                        ...
                                        <td><a href="#"
                                                style="text-decoration: none;color: black">ভর্তি পরীক্ষার প্রশ্ন</a></td>
                                        <td>
                                            <a href="#"
