@extends('layout.main')
@push('title')
    <title>Tearchers Information</title>
@endpush
                        ...
                        <div class="col-sm-9 col-12">
                            ...
                            <div class="col-sm-12 col-12 p-0">
                                ...
                                <div class="row">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                        <center><img src="{{url('/images/1741220842340680.jpg')}}" class="img-fluid rounded" id="" style="max-height: 100px"><br></center>
                                    </td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                        <center><img src="{{url('/images/1741221056599038.jpg')}}" class="img-fluid rounded" id="" style="max-height: 100px"><br></center>
                                    </td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                        <center><img src="{{url('/images/1741221297197991.jpg')}}" class="img-fluid rounded" id="" style="max-height: 100px"><br></center>
                                    </td>
