                ...
                <div class="col-sm-9 col-12">
                    ...
                    <div class="col-sm-12 col-12 p-0" data-aos="fade-in" data-aos-duration="2000">
                        <ul class="list-group p-0">
                            <li class="list-group-item font-weight-bold bg-success text-light" id="about">রেড ক্রিসেন্ট
                                নিউজ</li>
                        </ul>
                        <li class="list-group-item pb-5">
                            ...
                            <div class="row mt-3 border p-3">
                                <div class="col-md-3 col-12">
                                    <img src="{{ url('images/130822_06_49_16.jpg') }}" class="img-fluid"
                                        style="max-height: 300px;">
                                </div>
                                <div class="col-md-9 col-12">
                                    <h4><a href="#" class="text-dark">Red Crescent</a></h4>
                                    <span style="color: gray;">2022-08-04</span><br><br>
                                    <span>
                                        <p><span style="color: rgb(32, 33, 34); font-family: sans-serif;">The&nbsp;</span><b
                                                style="color: rgb(32, 33, 34); font-family: sans-serif;">Bangladesh Red
                                                Crescent Society</b><span
                                                style="color: rgb(32, 33, 34); font-family: sans-serif;">&nbsp;(also
                                                abbreviated as BDRCS) is a humanitarian organiza...</span><br>
