@extends('layout.main')
@push('title')
    <title>Message Form Head Sir</title>
@endpush
                            ...
                            <div class="container">
                                ...
                                <div class="col-sm-9 col-12">
                                    ...
                                    <div class="image" style="text-align:center!important;">
                                        <img src="https://skillbasedit.com/demo/public/otherimage/6511b91624acf.gif" class="img-fluid p-2" style="max-height:300px;">
                                    </div>
                                    <div class="name" style="text-align: center;margin-top:20px;font-size:20px;">
                                    <p>আবু বকর সিদ্দিক</p>
                                    </div>
                                    <div>
                                        <p></p><p style="margin-bottom: 10px;">বর্তমান যুগ বিজ্ঞান ও তথ্য-প্রযুক্তির উৎকর্ষের যুগ। আধুনিক বিশ্বের সকল ক্ষেত্রে বিজ্ঞান ও তথ্য-প্রযুক্তি পালন করছে জাদুর কাঠির মতো বিস্ময়কর ভূমিকা। শিক্ষা ক্ষেত্রে বিজ্ঞান ও তথ্য-প্রযুক্তির ব্যবহার ইতিমধ্যেই বিশ্বব্যাপী বিরাট আলোড়নের সৃষ্টি করেছে। এ প্রেক্ষাপটে বাংলাদেশ সরকার এদেশের শিক্ষা ব্যবস্থা আধুনিকায়নের লক্ষ্যে বিজ্ঞান ও তথ্য-প্রযুক্তির ব্যবহারকে সর্বাধিক গুরুত্ব দিয়ে সকল শিক্ষা প্রতিষ্ঠানকে অভিন্ন নেটওয়ার্কের আওতায় নিয়ে আসার ব্যাপারে ব্যাপক কর্মসূচি গ্রহণ করেছে।<br></p><p style="margin-bottom: 10px;">বাংলাদেশের শিক্ষা ব্যবস্থার আধুনিকায়নে সরকারের আহ্বানে সাড়া দিয়ে যে সকল শিক্ষা প্রতিষ্ঠান ইতোমধ্যে বিজ্ঞান ভিত্তিক শিক্ষা উপকরণ ও তথ্য-প্রযুক্তির ব্যবহার শুরু করেছে ।&nbsp; এ শিক্ষা প্রতিষ্ঠানে ইতিমধ্যে বেশ কয়েকটি স্মার্ট ক্লাস রুম স্থাপন করা হয়েছে। এছাড়াও কলেজ একাডেমিক ও প্রশাসনিক কর্মকাণ্ডকে আরো গতিশীল ও তথ্য-প্রযুক্তি বান্ধব করার লক্ষ্যে একটি সমৃদ্ধ ওয়েব সাইট চালু করার কার্যক্রম সম্পন্ন করা হয়েছে।<br></p><p style="margin-bottom: 10px;">আমি আশাকরি এর মধ্যদিয়ে আমাদের শিক্ষার্থীরাই শুধু নয় সারা দেশের শিক্ষা ব্যবস্থার একটি সামাজিকরণ সম্ভব হবে। আমি আমাদের বিদ্যালয়ের সহকর্মী, শিক্ষার্থী, অভিভাবক সুধিমহল সকলকে আন্তরিক শুভেচ্ছা জানাই ।aaa<br></p><p style="margin-bottom: 10px;"><br></p><p style="margin-bottom: 10px;">প্রধান শিক্ষক<br></p><p style="margin-bottom: 10px;">আল-হেলাল একাডেমী সোনাগাজী&nbsp;<br></p><p style="margin-bottom: 10px;">সোনাগাজী, ফেনী।&nbsp;</p>
                                    </div>
