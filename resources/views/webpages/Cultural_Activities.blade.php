                ...
                <div class="col-sm-9 col-12">
                    ...
                    <div class="col-sm-12 col-12 p-0" data-aos="fade-in" data-aos-duration="2000">
                        <ul class="list-group p-0">
                            <li class="list-group-item font-weight-bold bg-success text-light" id="about">সাংস্কৃতিক
                                কার্যক্রম</li>
                        </ul>
                        <li class="list-group-item pb-5">
                            ...
                            <div class="row mt-3 border p-3">
                                <div class="col-md-3 col-12">
                                    <img src="{{ url('images/150822_12_21_49.jpg') }}" class="img-fluid"
                                        style="max-height: 300px;">
                                </div>
                                <div class="col-md-9 col-12">
                                    <h4><a href="#" class="text-dark">বার্ষিক সাংস্কৃতিক অনুষ্ঠান</a></h4>
                                    <span style="color: gray;">2022-08-13</span><br><br>
                                    <span>
                                        <p><br></p>...
                                    </span><br>
