           ...
           <div class="col-sm-12 col-12 p-0">
             <div class="row">
                 ...
                 <table class="table table-bordered "id="studenttable">
                      <tr>
                    <td colspan="2">
                     <center><img src="{{url('/images/1741225305224286.png')}}" class="img-fluid rounded" id="" style="max-height: 100px"><br></center>
                   </td>
