                    ...
                    <div class="col-sm-12 col-12 p-0" data-aos="fade-in" data-aos-duration="2000">
                        ...
                        <li class="list-group-item">
                            <div style="font-size: 14px; line-height: 25px; text-align: justify;">
                                <p
                                    style="padding: 0px; color: rgb(33, 37, 41); font-family: &quot;Baloo Chettan 2&quot;, AdorshoLipi, cursive; text-align: justify;">
                                    <img src="{{ url('images/download.jpg') }}" alt="" srcset=""
                                        style="width: 1009px;"
                                        data-filename="240569278_1789918941180721_7434065025866303330_n.jpg"><br>
                                </p>
                            </div>
